...
class FacebookUser(BirthdayContact):
    """Backward-compatible Facebook-specific contact adapter."""

    def __init__(self, id, name, profile_url, profile_picture_uri, birthday_day, birthday_month, birthday_year):
        super().__init__(id, name, profile_url, profile_picture_uri, birthday_day, birthday_month, birthday_year)
    ...
    def __eq__(self, other):
        return isinstance(other, BirthdayContact) and self.id == other.id
